...
*** Random Other Packages
    ...
    #+END_SRC
    Add the =notmuch= email package to the list of directories to load
    package from:
    #+BEGIN_SRC emacs-lisp
...
** Multi-Cursor Mode
   ...
   #+END_SRC
** Work-Log Package
   This is my own very simple package to help track work items.  The
   main gateway is through org-capture, but this binding takes me
   straight to the current days work log.
   #+BEGIN_SRC emacs-lisp
...
** Template System
   ...
   #+END_SRC
** Org Mode Setup
   I've split the =org-mode= settings out into their own file.
   #+BEGIN_SRC emacs-lisp
